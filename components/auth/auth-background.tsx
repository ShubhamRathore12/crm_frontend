...
export function AuthBackground() {
  return (
    <div className="fixed inset-0 -z-10 bg-[#282C20] overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-20 transition-transform duration-[20s] ease-linear hover:scale-110 pointer-events-none">
        <svg
          ...
          className="w-full h-full text-[#D9FF00]"
        >
          <filter id="noise">
      ...
      <div className="absolute top-1/4 -left-20 w-96 h-96 bg-[#D9FF00]/10 rounded-full blur-[120px] animate-float" />
      <div className="absolute bottom-1/4 -right-20 w-[500px] h-[500px] bg-[#D9FF00]/5 rounded-full blur-[150px] animate-float-delayed" />
    </div>
  );
}
