      ...
      <div className={cn(
        ...
        <div className="text-center space-y-2 animate-fadeInUp">
          ...
          <h1 className="text-[#F4F4ED] font-serif text-6xl md:text-7xl leading-tight tracking-tighter">
            CREATE <span className="text-[#D9FF00]">ACCOUNT</span>
          </h1>
        ...
        <form onSubmit={handleRegister} className="space-y-8 animate-fadeInUp delay-200">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-4 px-6 rounded-lg bg-[#D9FF00] text-black font-semibold hover:bg-[#c4e600] transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {loading ? (
          ...
          <p className="text-center text-sm text-muted-foreground/60">
            Already have access?{" "}
            <Link href="/login" className="text-[#D9FF00] hover:underline">
              Sign in
            </Link>
          </p>
        </form>
