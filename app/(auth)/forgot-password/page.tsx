    ...
    <main className="relative min-h-screen flex items-center justify-center p-6 selection:bg-[#D9FF00] selection:text-black">
      ...
      <div className="w-full max-w-md space-y-12">
        ...
        <div className="text-center space-y-2 animate-fadeInUp">
          <Link
            href="/login"
            className="inline-flex items-center text-[10px] font-mono text-[#D9FF00] hover:text-white transition-colors uppercase tracking-[0.3em] mb-6"
          >
          ...
          <h1 className="text-[#F4F4ED] font-serif text-5xl md:text-6xl leading-tight tracking-tighter">
            RECOVER <span className="text-[#D9FF00]">KEY</span>
          </h1>
            ...
            <form onSubmit={handleSendOtp} className="space-y-8">
              <div className="space-y-6">
                <div className="group relative">
                  <label className="text-xs font-mono text-muted-foreground/50 uppercase tracking-widest transition-all focus-within:text-[#D9FF00]">
                    Target Email
                  </label>
                  <div className="flex items-center border-b border-[#F4F4ED]/20 py-2 transition-all focus-within:border-[#D9FF00]">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full flex justify-center items-center py-4 rounded-full text-sm font-bold bg-[#D9FF00] text-black hover:bg-white transition-all duration-300 disabled:opacity-50"
              >
          ...
          {step === "otp" && (
            <div className="space-y-8">
              <div className="space-y-6 text-center">
                <ShieldCheck className="h-12 w-12 text-[#D9FF00] mx-auto animate-pulse" />
                ...
                <div className="flex justify-center gap-2">
                  <input
                    ...
                    className="w-full max-w-[200px] bg-white/10 border-b-2 border-[#D9FF00] text-center text-4xl tracking-[0.5em] text-[#D9FF00] focus:ring-0 outline-none"
                    autoFocus
                  />
                </div>
              </div>
              <button
                ...
                className="w-full py-4 rounded-full text-sm font-bold bg-[#D9FF00] text-black hover:bg-white transition-all duration-300"
              >
                VERIFY TRANSMISSION
              </button>
            </div>
          ...
          {step === "success" && (
            <div className="space-y-8 text-center py-4">
              <div className="relative inline-block">
                <CheckCircle2 className="h-20 w-20 text-[#D9FF00] mx-auto" />
                <div className="absolute inset-0 bg-[#D9FF00]/20 rounded-full blur-xl animate-pulse" />
              </div>
              ...
              <Link
                href="/login"
                className="block w-full py-4 rounded-full text-sm font-bold bg-[#D9FF00] text-black hover:bg-white transition-all duration-300"
              >
                RETURN TO SIGN IN
              </Link>
            </div>
